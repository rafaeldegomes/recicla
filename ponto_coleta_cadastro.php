                        ...
                        <form action="controller/cadastra_ponto_coleta.php" method="POST">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input class="form-control" type="hidden" name="id_usuario" id="id_usuario"
                                        value="<?php echo $id; ?>">
                                    <label for="example-text-input" class="col-sm-6 col-form-label">Nome do Ponto de
                                        Coleta</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" aria-label="Default select example" name="bairro"
                                            id="bairro">
                                            ...
                                            <?php
                                                ...
                                                ?>
                                            <option value="<?php echo $row["id_bairro"]; ?>"><?php echo $row["nome"]; ?>
                                            </option>
                                            <?php
                                                }
                                                ?>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                    <option value="<?php echo $row2["id_residuo"]; ?>">
                                        ...
                                        <br>
                                        <button type="button" class="btn btn-secondary" id="add-entry">Adicionar mais
                                            dias e horários</button>
                                        <br>
                                ...
                                <div class="col">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <label class="col-sm-12 col-form-label">Visualizar Ponto de Coleta no
                                            Mapa</label>
                                        <br><br>
                            ...
                            <div class="row">
                                ...
                                <button type="submitt" class="btn btn-primary waves-effect waves-light">Cadastrar Ponto
                                    de Coleta</button>
    ...
    <script>
        document.getElementById('add-entry').addEventListener('click', function () {
            ...
            fetch('fetch_residuos.php')
                ...
                .then(data => {
                    let residuosOptions = data.map(residuo =>
                        `<option value="${residuo.nome}">${residuo.nome}</option>`).join('');
