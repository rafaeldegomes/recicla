  ...
  <div class="row">
    <div class="col"><div class="card">
                                            <div class="card-body">
                                                ...
                                                <p class="mb-0 font-size-14 fw-bold mt-2 text-truncate">126<span class="text-muted fw-normal"> ~ vs. previous month</span></p></div>
    <div class="col"><div class="card">
                                            <div class="card-body">
                                                <div class="d-flex flex-wrap pb-3 gap-3">
                                                    <div class="flex-grow-1 overflow-hidden">
    ...
    <div class="col"><div class="card">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="pie-chart" style="height: 280px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); position: relative;" class="e-charts" _echarts_instance_="ec_1699224608570"><div style="position: relative; width: 164px; height: 140px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;"><canvas data-zr-dom-id="zr_0" width="330" height="125" style="position: absolute; left: 0px; top: 0px; width: 264px; height: 140px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas></div><div class="" style="position: absolute; display: block; border-style: solid; white-space: nowrap; z-index: 9999999; box-shadow: rgba(0, 0, 0, 0.2) 1px 2px 10px; transition: opacity 0.2s cubic-bezier(0.23, 1, 0.32, 1) 0s, visibility 0.2s cubic-bezier(0.23, 1, 0.32, 1) 0s, transform 0.4s cubic-bezier(0.23, 1, 0.32, 1) 0s; background-color: rgb(255, 255, 255); border-width: 1px; border-radius: 4px; color: rgb(102, 102, 102); font: 14px / 21px &quot;Microsoft YaHei&quot;; padding: 10px; top: 0px; left: 0px; transform: translate3d(-129px, 98px, 0px); border-color: rgb(65, 204, 131); pointer-events: none; visibility: hidden; opacity: 0;">Total sales <br>Facebook : 1548 (60.42%)</div></div>
