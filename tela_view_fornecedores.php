                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Visualizar Fornecedor</h4>
                        ...
                        $query_total_fornecedores = "SELECT * FROM fornecedores where id_fornecedores = '$id_fornecedores'";
                        ...
                        <div class="row">
                            <div class="modal-body">
                                <form action="edita_fornecedores.php" method="POST">
                                    <input type="hidden" id="id" name="id" value="<?php echo $row['id_fornecedores']; ?>">
                                    <div class="row">
                                        <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" type="text" name="endereço" id="endereço"
                                                    placeholder="Digite o endereço" id="example-text-input"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col" style="text-align: left;">
                                            <a href='fornecedores.php' type="button"
